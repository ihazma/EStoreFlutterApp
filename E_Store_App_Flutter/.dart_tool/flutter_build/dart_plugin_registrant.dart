...
import 'package:share_plus_linux/share_plus_linux.dart' as share_plus_linux;
...
import 'package:share_plus_windows/share_plus_windows.dart' as share_plus_windows;
...
class _PluginRegistrant {
  ...
  static void register() {
    if (Platform.isAndroid) {
      ...
      try {
        share_plus_linux.ShareLinux.registerWith();
      } catch (err) {
        print(
      ...
      try {
        share_plus_windows.ShareWindows.registerWith();
      } catch (err) {
        print(
